...
@Tag(name = "avatar-operations", description = """
        The endpoints contained here are intended for operations related to passenger avatars. For example: uploading an avatar,
...
public interface AvatarOperations {
    ...
    @Operation(summary = "Uploads a new avatar for a passenger",
            description = """
                    Uploads a new avatar for a specific passenger. Only accessible by ADMIN or DRIVER.
                    ...
                    - The passenger must exist.

                    Example request:
                    POST /api/v1/passengers/1/avatars/upload
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "413", description = "File size exceeds the maximum allowed limit"),
    ...
    @Operation(summary = "Retrieves a passenger's avatar by ID",
            description = """
                    Retrieves a passenger's avatar by their ID.

                    Example request:
                    GET /api/v1/passengers/1/avatars
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Avatar or passenger not found")
    })
    ResponseEntity<InputStreamResource> getAvatar(@PathVariable("id") Long id);

    @Operation(summary = "Deletes a passenger's avatar by ID",
            description = """
                    Deletes a passenger's avatar by their ID. Only accessible by ADMIN or DRIVER.

                    Example request:
                    DELETE /api/v1/passengers/1/avatars
